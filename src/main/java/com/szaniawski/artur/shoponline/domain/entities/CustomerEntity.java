...
public class CustomerEntity extends AbstractEntity implements Serializable {
     ...
     *
     * @param TransactionEntity as transaction.
     */
    ...
    public static class CustomerEntityBuilder {
         ...
         *
         * @param Long as version of customer.
         ...
         *
         * @param String as first name of customer.
         ...
         *
         * @param String as last name of customer.
         ...
         *
         * @param LocalDate as date of birth of customer.
         ...
         *
         * @param String as mobile of customer.
         ...
         *
         * @param String as mail of customer.
         ...
         *
         * @param AdressData as adress for customer.
         ...
         *
         * @param List of TransactionEntity as transactions.
         ...
         *
         * @param Obligatory String firstname, String lastname, String mobile,.
