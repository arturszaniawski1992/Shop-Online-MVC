...
public class OrderEntity extends AbstractEntity implements Serializable {
    ...
    public static class OrderEntityBuilder {
         ...
         *
         * @param Long as version for order.
         * @return Id of order.
         */
         ...
         *
         * @param Integer as amount for order.
         ...
         *
         * @param PurchasedProductEntity as product for order.
         ...
         *
         * @param TransactionEntity as transaction for order.
         ...
         *
         * @param Obligatory String amount.
         * @return Order entity.
         */
